...
{
    public partial class BuscarFabricantePorNombreForm : Form
    {
        public BuscarFabricantePorNombreForm()
        {
            InitializeComponent();
        }
        ...
        private async void btnBuscar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var m = await ApiService.Instance.GetManufacturerByNameAsync(txtNombre.Text.Trim());
                btnBuscar.Enabled = true;

                if (m == null)
                {
                    MessageBox.Show("No se encontró un fabricante con ese nombre.", "No encontrado",
