package com.davidperez.supplycontractservice.dto;
...
@Data
@NoArgsConstructor
@Schema(description = "Datos para crear o actualizar un contrato de suministro")
public class SupplyContractRequest {
    ...
    @Schema(description = "Número único del contrato (clave primaria)", example = "CNT-2024-001", requiredMode = Schema.RequiredMode.REQUIRED)
